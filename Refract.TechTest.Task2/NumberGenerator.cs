...
namespace Refract.TechTest.Task2
{
    public class NumberGenerator
    {
        ...
        /// <summary>
        /// Teh dreaded goto statement, almost universally hated and with good reason.
        /// Many people don't even know that C# has this feature
        /// </summary>
        ...
        /// <summary>
        /// Using the LINQ Enumerable.Range function, though this does feel a little like cheating as it
        /// contains a for loop internally.
        ...
        public IEnumerable<int> GetNumbersUsingRecursion(int n)
        {
            ...
            CollectAllNumbers(n, allNumbers);
            
            return allNumbers;
        }

        private static void CollectAllNumbers(int n, List<int> allNumbers)
        {
            if (n > 1)
            {
